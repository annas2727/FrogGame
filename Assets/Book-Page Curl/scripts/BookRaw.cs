...
public class BookRaw : MonoBehaviour {
    ...
    public void ReleasePage()
    {
        if (pageDragging)
        {
            ...
            if (distanceToRight < distanceToLeft && mode == FlipMode1.RightToLeft)
                TweenBack();
            else if (distanceToRight > distanceToLeft && mode == FlipMode1.LeftToRight)
                TweenBack();
            else
                TweenForward();
        }
